...
class LibraryManagementSystem:
    ...
    def see_available_books(self):
        for id_b, book_info in self.books.items():
            if book_info[1] == "available":
                print(id_b, book_info[0], "\n")

    def borrow_book(self):
        borrowed_book_id = input("Podaj id książki, którą chcesz wypożyczyć: ")
    ...
    def return_book(self):
        return_book_id = input("Podaj id książki, którą chcesz zwrócić: ")
...
if __name__ == "__main__":
    m1 = LibraryManagementSystem("Bib1")
    m1.open()